...
const PengeluaranSec = () => {
    const [tambah,setTambah] = useState(false)
    return(
        <div className="w-full text-black p-4 relative">
            <img src={bgAmico} className='absolute -z-50 right-0' alt="" />
            <h1 className='font-medium text-[24px]'>Pengeluaran</h1>
            <br /> 
            <div className="w-full h-auto bg-white rounded-xl shadow-lg p-4 relative">
                {tambah && <Tambah setTambah={setTambah} tambah={tambah}/>}
                <div className="w-1/2 h-[50px] bg-main rounded-tl-xl rounded-br-xl text-center leading-[50px] -mx-4"><h3 className='font-bold text-[14px] text-white'>Transaksi Keluar</h3></div>
                <br />
